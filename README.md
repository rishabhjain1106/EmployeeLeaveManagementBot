# LeaveManagementBot
Manage holidays and leaves of Employees.
...
- Navigate to `LeaveManagementBot` folder
- Select `LeaveManagementBot.bot` file
...
msbot clone services --name "LeaveManagementBot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
